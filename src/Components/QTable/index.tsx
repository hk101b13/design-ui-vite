...
import { ThemeContext, AddImportantToStyles } from "../QThemeProvider";
...
function setTableColor(tableColor?: TableColor): TableColor {
  ...
  let newTableColor = {
    headerColor: QColors.schemes.light.primary,
    rowColor: QColors.schemes.light.onPrimaryContainer,
    hoverRowColor: QColors.schemes.light.primaryContainer,
    textColor: QColors.schemes.light.onPrimary,
  };
  if (colorScheme) {
    newTableColor = {
...
export default (props: CustomTableProps & TableProps<any>) => {
  return (
    <>
